...
ActiveRecord::Schema.define(version: 20140523220312) do
  ...
  add_index "amps", ["project_id"], name: "index_amps_on_project_id", using: :btree
  ...
  add_index "hostings", ["project_id"], name: "index_hostings_on_project_id", using: :btree
  ...
  add_index "ranks", ["project_id"], name: "index_ranks_on_project_id", using: :btree
